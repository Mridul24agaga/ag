...
(function ($) {
  ...
  var rtsJs = {
        ...
        var swiper = new Swiper(".mySwiperh2_clients", {
          ...
          on: {
            slideChangeTransitionEnd: function () {
              // Force pagination update after transition ends
              this.pagination.update();
            },
            touchEnd: function () {
              // Update pagination after touch ends
              setTimeout(() => {
                this.pagination.update();
              }, 100);
            },
            slideChange: function () {
              // Update pagination immediately when slide changes
              this.pagination.update();
            },
            touchMove: function () {
              // Update pagination during touch movement
              this.pagination.update();
            },
            drag: function () {
              // Update pagination during drag
              this.pagination.update();
            },
            transitionStart: function () {
              // Update pagination when transition starts
              this.pagination.update();
            },
            transitionEnd: function () {
              // Update pagination when transition ends
              this.pagination.update();
            }
          },
          breakpoints: {
    ...
    backToTopInit: function () {
      // Disabled - replaced with WhatsApp floating button
